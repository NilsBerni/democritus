...
from implementations.Camargo.model_training.models import model_gru_shared_cat as mshcatg, \
    model_concatenated as mcat, model_gru_specialized as mspecg, model_gru_concatenated as mcatg, \
    model_specialized as mspec
from implementations.Camargo.model_training.models import model_shared_cat as mshcat
