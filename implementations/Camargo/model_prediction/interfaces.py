...
from implementations.Camargo.model_prediction import suffix_predictor as sp, next_event_predictor as nep, \
    event_log_predictor as elp, suffix_samples_creator as ssc, next_event_samples_creator as nesc
